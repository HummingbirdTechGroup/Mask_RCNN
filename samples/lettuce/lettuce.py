"""
Mask R-CNN
Train on the Lettuce segmentation dataset and implement color splash effect.
...
Usage: import the module (see Jupyter notebooks for examples), or run from
    ...
    python samples/lettuce/lettuce.py train --dataset=/path/to/lettuce/  --weights=coco --config_file=/path/to/config/file

    # Train a new model starting from ImageNet weights
    python samples/lettuce/lettuce.py train --dataset=/path/to/lettuce/ --weights=imagenet --config_file=/path/to/config/file

    # Continue training a model that you had trained earlier
    python samples/lettuce/lettuce.py train --dataset=/path/to/lettuce/  --weights=/path/to/weights.h5 --config_file=/path/to/config/file

    # Continue training the last model you trained. This will find
    # the last trained weights in the model directory.
    python samples/lettuce/lettuce.py train --dataset=/path/to/lettuce/  --weights=last --config_file=/path/to/config/file


    # Run LETTUCE evaluation on the la--st trained model
    python samples/lettuce/lettuce.py evaluate --dataset=/path/to/lettuce
    / --weights=last --config_file=/path/to/config/file

    # Apply color splash to an image
    python lettuce.py splash --weights=/path/to/weights/file.h5 --image=<URL or path to file>
...
class LettuceConfig(Config):
    """Configuration for training on the lettuce  dataset.
...
class LettuceDataset(utils.Dataset):
    ...
    def load_lettuce(self, dataset_dir, subset):
        """Load a subset of the Lettuce dataset.
        ...
        # Load annotations
        # from hb-lettuce-segmentation-dataset.json
        ...
        # Our lettuce segmentation dataset builder saves images in the JSON even if they don't have any
    ...
    def load_mask(self, image_id):
       ...
       Returns:
        ...
        """
        # If not a lettuce dataset image, delegate to parent class.
...
def train(model, config, augmentation = False, epochs = 30):
    ...
    dataset_train.load_lettuce(args.dataset, "train")
    dataset_train.prepare()

    # Validation dataset
    dataset_val = LettuceDataset()
    dataset_val.load_lettuce(args.dataset, "val")
    dataset_val.prepare()
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description='Train Mask R-CNN to detect lettuces.')
    ...
    parser.add_argument('--dataset', required=False,
                        metavar="/path/to/lettuce/dataset/",
                        help='Directory of the Lettuce dataset')
    ...
    if args.config_file:
        ...
        from config import LettuceConfig
